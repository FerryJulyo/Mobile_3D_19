...
import com.julyo.latihanretrofit.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.repo == variableId) {
            setRepo((com.julyo.latihanretrofit.models.Repo) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setRepo(@Nullable com.julyo.latihanretrofit.models.Repo Repo) {
        this.mRepo = Repo;
        synchronized(this) {
            mDirtyFlags |= 0x1L;
        }
    ...
    protected void executeBindings() {
        ...
        com.julyo.latihanretrofit.models.Repo repo = mRepo;
