...
public class CardViewHeroAdapter extends RecyclerView.Adapter<ferry.julyo.wildriftmastery.CardViewHeroAdapter.CardViewViewHolder> {
    private ArrayList<ferry.julyo.wildriftmastery.Hero> listHero;

    CardViewHeroAdapter(ArrayList<ferry.julyo.wildriftmastery.Hero> list) {
        this.listHero = list;
    }
    ...
    public void onBindViewHolder(@NonNull final CardViewViewHolder holder, int position) {
        ferry.julyo.wildriftmastery.Hero hero = listHero.get(position);
